...
function Body() {
  return (<div>
    ...
    <img src='https://t3.ftcdn.net/jpg/06/26/79/80/360_F_626798006_mew3jiniPEN1mnikNEgiNvvPsUwewwRo.jpg' width="100%"></img>
        ...
        <form method="get" action="http://localhost:3008/buses">
        <div className='container a'><div className='bg-light b border shadow pe-5'>
            <div  className='container d-flex'>
                <div className='p-2 col-3 boder d-flex rounded 2 bg-light'>
                    <img className='mt-2' src={bus} height="20px"></img>
          <div><input className='btn' name='starting' type='text' placeholder='From station' required></input></div>
        </div>
        ...
        <div className='p-2 col-3 boder d-flex ms-5 rounded 2 bg-light'>
          ...
          <div><input className='btn' name='ending' type='text' placeholder='To Station' required></input></div>
        </div>
        <div className='p-2 col-3 boder d-flex rounded 2 bg-light'>
          <div><input className='btn' type='date'></input></div>
          <button className='btn btn-secondary'>Today</button>
          <button className='btn btn-secondary ms-1 me-4'>Tomorrow</button>
        </div>
        <button className='btn btn-danger ms-5 ps-5 pe-5 mt-1'><h5>Search</h5></button>
        </div>
        </div>
        </div>
        </form>
